...
public class StringProcessor {
	...
	public static int numWordsInPara(String str) {
	...
	public static int numCharsIncSpacesInPara(String str) {
		return str.length();
	}
	
	// count num chars excluding spaces in a string
	public static int numCharsExcSpacesInPara(String str) {
		int count = 0;
	...
	public static int numPara(String str) {
	...
	public static void main(String[] args) {
		System.out.println(numWordsInPara("Hi, I am the new guy"));
	}
	*/
